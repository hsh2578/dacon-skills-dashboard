...
investment_points 중 CATALYST_NEAR_TERM 성격 항목을 본다.

| 상태 | 판정 |
|---|---|
| 6개월 내 구체적 촉매(실적 턴어라운드·신제품 출시·컴백·수주·정책)가 출처 태그와 함께 명시 | 강한 해소 신호 (+3) |
| 촉매가 있으나 시점 불명확하거나 구조적 드라이버(THESIS_DRIVER)만 존재 | 보통 (+1) |
| 촉매 없음 / 모멘텀이 모호 / "확인 필요" 태그 위주 | Value Trap 의심 (−2) |

### 4.2 이익 회복 가시성 (2순위)

RECENT_EARNINGS 항목 + Forward PER 개선이 실제 실적으로 뒷받침되는지.

| 상태 | 판정 |
|---|---|
| 최근 분기 실적 턴어라운드·가이던스 상향이 출처와 함께 확인 | +2 |
